...
public class WorkCalculator
{
	...
	public void calculaHoraExtra(Hour horaEntrada, Hour horaSaidaAlmoco, Hour horaVoltaAlmoco,
		Hour horaSaida)
	{
	...
	public void subtraiHoraExtra(Hour horaInicial, Hour horaFinal, Hour horaSaida)
	{
		...
		if (fezHoraExtra == true)
		{
			...
			System.out.println(
				"-------------------------------------------------------------------------------");
			System.out.println("Voc� fez horas positivas!");
			System.out.println("In�cio: " + dateConverter.dateFormatter(
				dateConverter.converteFormatoData(inicioHoraExtra)));
			System.out.println(
				"Fim: " + dateConverter.dateFormatter(dateConverter.converteFormatoData(horaSaida)));
		...
		if (fezHoraExtra == false)
		{
			...
			System.out.println(
				"-------------------------------------------------------------------------------");
			System.out.println("Voc� fez horas negativas!");
			System.out.println(
				"In�cio: " + dateConverter.dateFormatter(dateConverter.converteFormatoData(horaSaida)));
			System.out.println("Total: -" + quantidade.getHoras() + "h" + quantidade.getMinutos() + "m");
			System.out.println(
				"-------------------------------------------------------------------------------");
		}
